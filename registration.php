...
<head>
    ...
    <link rel="icon" href="images/1a.jpg">
               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-4">
						...
						<ul>
						<li>Choose from Wide varities of plants</li>
                        ...
                        <hr>
                        <img src="images/1a.jpg" alt="" class="img-fluid">
                        <p>Frequently Asked?</p>
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle collapsed" href="#faq1" aria-expanded="false"><i class="ti-info-alt" aria-hidden="true"></i>What is Plant Shop Customer Care Number?</a></h4>
                           </div>
                           <div class="panel-collapse collapse" id="faq1" aria-expanded="false" role="article" style="height: 0px;">
                              <div class="panel-body">For any inquiries about Plant Shop's diverse range of services and products or assistance with placing orders, don't 
							  hesitate to connect with our dedicated Customer 
							  Care team at +60 11-3630 6284. Whether you have specific 
                              questions about our menu, need support with the ordering process, or want to share feedback,
							  our team is here to provide prompt and personalized assistance. Your satisfaction is our top priority, and we encourage you to reach out to +60 11-3630 6284 for a seamless and enjoyable experience with Plant Shop.</div>
                           </div>
                        </div>
                        <!-- end:panel -->
						...
						<div class="panel">
                           ...
                           <div class="panel-collapse collapse" id="faq2" aria-expanded="true" role="article">
                              <div class="panel-body">No. At Plant Shop, we are delighted to offer complimentary delivery services to our valued customers.
							  ...
							  Enjoy the ease of having our plants delivered straight to your doorstep without any additional charges. It's our 
							  way of enhancing your experience and making your order experience with Plant Shop even more delightful.</div>
                           </div>
                        </div>
                        <!-- end:Panel -->
                        <h4 class="m-t-20">Contact Customer Support</h4>
                        <p> If you're looking for more help or have a question to ask, please feel free. </p>
                        <p> <a href="https://l.instagram.com/?u=https%3A%2F%2Fwa.me%2Fc%2F601136306284&e=AT3zqoyHxn1My6_jNZI7IQauplqhtRYoCWl9ycUni4E0NRK0tg0NgngK2BLlY-wueoqNWqnOmW_Yk8viTmTbGET9Psr3AA9hwr8iHQ" class="btn theme-btn m-t-15">Contact Us</a> </p>
                     </div>
                     <!-- /WHY? -->
                  </div>
               </div>
...
<a href="https://www.tiktok.com/@araroses19" target="_blank">
    <img src="images/t.png" alt="Tiktok" width="50" height="50">
					...
					<div class="col-xs-12 col-sm-3 popular-locations color-gray">
                        ...
                        <ul>
                            <li><a href="#">Arau</a> </li>
                            <li><a href="#">Beseri</a> </li>
                            <li><a href="#">Bintong</a> </li>
                            <li><a href="#">Kaki Bukit</a> </li>
                            <li><a href="#">Kuala Perlis</a> </li>
                            <li><a href="#">Kaki Bukit</a> </li>
                            <li><a href="#">Kangar</a> </li>
                            <li><a href="#">Simpang Ampat</a> </li>
                            <li><a href="#">Tambun Tulang</a> </li>
                            <li><a href="#">Mata Ayer</a> </li>
                        </ul>
                    </div>
