...
if(isset($_POST['submit'] ))
{
	...
	$mql = "update shop_category set c_name ='$_POST[c_name]' where c_id='$_GET[cat_upd]'";
	mysqli_query($db, $mql);
...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="images/1a.jpg">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">About Restaurant</span></a>
                            <ul aria-expanded="false" class="collapse">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">About Restaurants</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-body">
                                <form action='' method='post' >
                                    <div class="form-body">
                                        <?php $ssql ="select * from shop_category where c_id='$_GET[cat_upd]'";
