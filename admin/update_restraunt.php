					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "update shop set c_id='$_POST[c_name]', title='$res_name',email='$_POST[email]',phone='$_POST[phone]',url='$_POST[url]',o_hr='$_POST[o_hr]',c_hr='$_POST[c_hr]',o_days='$_POST[o_days]',address='$_POST[address]',image='$fnew' where rs_id='$_GET[res_upd]' ";  // store the submited data ino the database :images												mysqli_query($db, $sql); 
													mysqli_query($db, $sql); 
        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Update Shop Info</h3> </div>
            ...
            <div class="container-fluid">
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                                ...
                                <h4 class="m-b-0 ">Update Shop</h4>
                            
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                       <?php $ssql ="select * from shop where rs_id='$_GET[res_upd]'";
											 ...
											 <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="o_days" class="form-control custom-select"  data-placeholder="Choose a Category" tabindex="1">
														...
														<option value="mon-sat">mon-sun</option>
                                            ...
                                            <!--/span-->
											 ...
											 <div class="col-md-12">
                                                <div class="form-group">
                                                 ...
                                                 <?php $ssql ="select * from shop_category";
													$res=mysqli_query($db, $ssql); 
                                        ...
                                        <!--/row-->
                                        <h3 class="box-title m-t-40">Shop Address</h3>
                                        <hr>
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
			<footer class="footer"> © 2024 All rights reserved. Made  by <b> PLANT SHOP</a></b> Team. </footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
