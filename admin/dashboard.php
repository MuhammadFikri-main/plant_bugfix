                        ...
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle">
                                    <span><i class="fa fa-leaf f-s-40" aria-hidden="true"></i></span>
                                </div>
                        ...
                        <div class="card p-30">
                            <div class="media">
								...
								<a href="all_orders.php">
                                    <?php
$sql = "SELECT COUNT(*) AS orderCount FROM users_orders WHERE status IS NULL OR status NOT IN ('rejected', 'cancelled', 'closed')";
$result = mysqli_query($db, $sql);
$row = mysqli_fetch_assoc($result);

// Check if the query was successful and fetch the count
if ($result && isset($row['orderCount'])) {
    $orderCount = $row['orderCount'];
    echo "<h2>{$orderCount}</h2>";
} else {
    echo "<h2>Error fetching order count</h2>";
}
?>
