...
?>
    <td> <button type="button" class="btn btn-info" style="font-weight:bold;"><span class="fa fa-bars" aria-hidden="true">Customer place order</button></td>
<?php
...
<?php
    ...
    <td> <button type="button" class="btn btn-danger"><i class="fa fa-close"></i>Cancelled by customer</button></td>
<?php
}
?>
																						...
																						<?php																									
																							...
																							?>
																								...
																								<?php
																								echo '<a href="view_order.php?user_upd='.$rows['item_id'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-settings"></i></a>
																									</td>
																									</tr>';
            ...
            <!-- footer -->
            <footer class="footer"> © 2024 All rights reserved. PLANT SHOP</a></b> Team. </footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
